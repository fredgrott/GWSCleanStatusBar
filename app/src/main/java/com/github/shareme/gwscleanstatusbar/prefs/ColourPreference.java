...
public class ColourPreference extends Preference {
    ...
    public static class ColourDialogFragment extends DialogFragment implements View.OnClickListener {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            @SuppressLint("InflateParams") View footerView = LayoutInflater.from(getActivity()).inflate(R.layout.colour_preference_footer, null);
        ...
        private void showAddColourDialog() {
            @SuppressLint("InflateParams") View root = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_new_colour, null);
    ...
    static class Colour implements Comparable<Colour> {
        ...
        @Override
        public int compareTo(@NonNull Colour colour) {
